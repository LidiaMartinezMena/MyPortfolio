  ...
  const projects = [
    {
      ...
      description:
        "A responsive React component that displays a dotted world map with highlighted orange markers for different regions. A list of countries and regions (e.g., United States, Germany, Spain, etc.) is aligned alongside the map, allowing for a clear and modern representation of global presence or coverage.",
